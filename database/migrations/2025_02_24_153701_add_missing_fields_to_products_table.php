...
return new class extends Migration {
    ...
    public function down()
    {
        Schema::table('products', function (Blueprint $table) {
            $table->dropColumn([
                'stock_status', 'account', 'tax', 'lead_time', 'cost_price',
                'purchase_account', 'preferred_vendor', 'fixed_transport',
                'local_transport', 'air_transport', 'sea_transport', 'preferred_transport'
            ]);
        });
    }
};
